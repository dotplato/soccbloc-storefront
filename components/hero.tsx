...
const SLIDES: HeroSlide[] = [
  {
    ...
    videoSrc: "/videos/soccbloc-hero-1.mp4",
  },
  {
    id: 2,
    ...
    videoSrc: "/videos/soccbloc-hero-2.mp4",
  },
  {
    id: 3,
    ...
    videoSrc: "/videos/soccbloc-hero-3.mp4",
  },
];
...
export function Hero() {
  ...
  return (
    <section className="relative h-[80vh] min-h-[540px] overflow-hidden rounded-b-[2.5rem] bg-black text-foreground">
      {/* Background videos */}
      ...
      <div className="relative z-10 h-full">
        <div className="mx-auto flex h-full max-w-6xl flex-col px-4 py-4 sm:px-6 lg:px-8 lg:py-6">
          ...
          <div className="mt-10 flex flex-1 flex-col justify-center gap-8 sm:mt-16 lg:max-w-xl">
